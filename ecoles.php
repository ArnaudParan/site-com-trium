<div class="row" style="margin-top:30px">
	<div style="margin-top:30px" class="col-sm-offset-3 col-sm-6 bloc_contact">
		...
		<div class="lisere_bleu" style="margin-top:10px"></div>
	</div>
</div>
<div class="row" style="margin-top:30px">
	<div class="col-sm-offset-3 col-sm-6 bloc_contact">
		<div class="row">
			...
			<div class="col-sm-8 col-sm-pull-4" style="text-align:justify">
				<h1>Mines</h1>
...
<div class="row" style="margin-top:30px">
	<div class="col-sm-offset-3 col-sm-6 bloc_contact">
		...
		<div class="row" style="margin-top:10px"><div class="lisere_bleu"></div></div>
	</div>
</div>
<div class="row" style="margin-top:30px">
	<div class="col-sm-offset-3 col-sm-6 bloc_contact">
