...
<div class="container">
	...
	<header class="row">
		<div class="col-xs-5 col-sm-2 col-md-2 col-lg-1">
			<div class="col-md-6 col-xs-6"><a href="../entreprises.html"><img class="lang" src="../logos/french.png" alt="French"/></a></div>
			<div class="col-md-6 col-xs-6"><a href="#"><img class="lang" src="../logos/english.png" alt="English"/></a></div>
		</div>
		...
		<div class="col-xs-offset-0 col-sm-offset-0 col-md-offset-0 col-lg-offset-2 col-xs-12 col-sm-12 col-sm-7">
			...
			<nav class="navbar navbar-default">
				<div class="navbar-header">
					<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
						<span class="sr-only">For navigation</span>
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						...
						<li><a href="eleves.html">STUDENTS</a></li>
						<li class="active"><a href="entreprises.html">COMPANIES<span class="sr-only">current page</span></a></li>
						<li><a href="partenaires.html">PARTNERS</a></li>
			...
			<!--<nav class="row">
				...
				<div class="col-md-2">
					<a href="eleves.html">STUDENTS</a>
				</div>
				<div class="col-md-2">
					<a href="entreprises.html">COMPANIES</a>
				</div>
				<div class="col-md-2">
